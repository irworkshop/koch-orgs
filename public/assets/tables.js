...
window.JST['table'] = _.template('<div class="container-fluid">\n    <div class="table-filter tablesorter-default">\n        <label for="search">Filter:</label> \n        <input name="search" type="search">\n    </div>\n    <div class="pager tablesorter-default">  \n        <form>      \n            <div class="pagesize-wrapper">          \n                <span>Show </span>          \n                <select class="pagesize">             \n                    <option value="25">25</option>             \n                    <option value="50">50</option>             \n                    <option value="100">100</option>          \n                </select>          \n                <span> rows.</span>      \n            </div>  \n        </form>\n    </div>\n    <table id="<%= table_id %>" class="sortable table table-striped table-hover">\n        <thead>\n            <% _.each(columns, function(column) { %>\n            <th><%= rename[column] %></th>\n            <% }); %>\n        </thead>\n        <tbody>\n            <% _.each(data, function(row) { %>\n            <tr>\n                <% _.each(columns, function(column) { %>\n                <td><%= row[column] %></td>\n                <% }); %>\n            </tr>\n            <% }); %>\n        </tbody>\n    </table>\n    <div class="pager tablesorter-default">      \n        <div class="pagenav-wrapper">          \n            <a href="#" class="prev">Previous</a>          \n            <input type="text" class="pagedisplay" readonly="readonly">          \n            <a href="#" class="next">Next</a>      \n        </div>\n    </div>\n</div>');
})();